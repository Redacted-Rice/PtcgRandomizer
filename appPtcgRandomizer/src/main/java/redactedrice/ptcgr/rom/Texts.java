...
public class Texts {
    ...
    public void convertAndAddBlocks(Blocks blocks) {
        ...
        for (; usedCount < count(); textId++) {
            ...
            // Create and add the text as appropriate (i.e. a hybrid if it was read from the rom or
            // a movable
            // if its a new block)
        ...
        // Create the fixed block. Since its all fixed size, we can just pass the length of the
        // block
