...
public class Settings {
    ...
    public static class TypeSpecificData {
        ...
        }; // Need to do logic to make sure it matches with two following ones
    ...
    public static class AttacksData extends MovesData {
        ...
        // Applicable always - maybe also applicable to poke powers if updating their energy types
        // for things like energy trans
