...
public class ActionCategories {
    ...
    private static List<String> categories = new ArrayList<String>(List.of(CATEGORY_ALL,
            CATEGORY_CARDS, CATEGORY_MOVES, CATEGORY_DECKS, CATEGORY_PACKS, CATEGORY_TWEAKS));
