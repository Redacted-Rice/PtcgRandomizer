...
-- One line each for prevEvoIdx slot topology (1->3, 2->3, 3->2). Keep isolated so pools dont mix.
local prevDist1To3 = {
	{
		id = "MONSTER_100",
		name = "PrevDistBasic1",
...
local prevDist3To2 = {
	{
		id = "MONSTER_121",
		name = "PrevDistFossilBasic",
		type = "MONSTER_FIRE",
		stage = "BASIC",
		prevEvoName = "",
		evoLineId = 102,
		evoLineMaxStage = "STAGE_2",
	},
	{
		id = "MONSTER_129",
		name = "PrevDistFossilS1A",
		type = "MONSTER_FIRE",
		stage = "STAGE_1",
		prevEvoName = "PrevDistFossilBasic",
		evoLineId = 102,
		evoLineMaxStage = "STAGE_2",
	},
	{
		id = "MONSTER_130",
		name = "PrevDistFossilS1B",
		type = "MONSTER_FIRE",
		stage = "STAGE_1",
		prevEvoName = "PrevDistFossilBasic",
		evoLineId = 102,
	...
	{
		id = "MONSTER_138",
		name = "PrevDistFossilS2A",
		type = "MONSTER_FIRE",
		stage = "STAGE_2",
		prevEvoName = "PrevDistFossilS1A",
		evoLineId = 102,
		evoLineMaxStage = "STAGE_2",
	},
	{
		id = "MONSTER_139",
		name = "PrevDistFossilS2B",
		type = "MONSTER_FIRE",
		stage = "STAGE_2",
		prevEvoName = "PrevDistFossilS1A",
		evoLineId = 102,
...
return {
	...
	caseFor("prev_dist_2_to_3", byStageAndMax, prevDist2To3, prevDist2To3, {
		...
		{ id = "MONSTER_118", name = "PrevDist2S1A", stage = "STAGE_1", prevEvoName = "PrevDist2BasicB" },
	}),

	-- 1 basic, 3 stage 1, 2 stage 2. Fossil shape. Both stage 2 slots share prevEvoIdx 2 (first stage 1 slot).
	caseFor("prev_dist_3_to_2", byStageAndMax, prevDist3To2, prevDist3To2, {
		...
		{ id = "MONSTER_138", name = "PrevDistFossilS2A", stage = "STAGE_2", prevEvoName = "PrevDistFossilS1B" },
	}),
