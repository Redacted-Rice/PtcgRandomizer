...
card_sets.STD_TEST_CARDS_ROM = {
	...
	{ id = "MONSTER_006", name = "SoloSix", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 15, hp = 80, retreatCost = 3, numMoves = 2,
	...
	{ id = "MONSTER_010", name = "InvertedBasic", type = "MONSTER_FIRE", stage = "BASIC",
		evoLineMaxStage = "STAGE_1", evoLineId = 1, hp = 40, retreatCost = 1, numMoves = 2,
		moves = fields.moves({ { name = "HeatWave" }, { name = "Burn" } }) },
	{ id = "MONSTER_011", name = "InvertedEvo", type = "MONSTER_FIRE", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_1", prevEvoName = "InvertedBasic", evoLineId = 1, hp = 80, retreatCost = 3, numMoves = 1,
	...
	{ id = "MONSTER_012", name = "OrderedBasic", type = "MONSTER_WATER", stage = "BASIC",
		evoLineMaxStage = "STAGE_1", evoLineId = 2, hp = 30, retreatCost = 1, numMoves = 2,
	...
	{ id = "MONSTER_013", name = "OrderedEvo", type = "MONSTER_WATER", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_1", prevEvoName = "OrderedBasic", evoLineId = 2, hp = 50, retreatCost = 2, numMoves = 2,
	...
	{ id = "MONSTER_014", name = "SplitBasic", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "STAGE_2", evoLineId = 3, hp = 90, retreatCost = 3, numMoves = 1,
		moves = fields.moves({ { name = "VineWhip" } }) },
	{ id = "MONSTER_015", name = "SplitBasic", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "STAGE_2", evoLineId = 3, hp = 40, retreatCost = 1, numMoves = 2,
	...
	{ id = "MONSTER_016", name = "SplitEvo", type = "MONSTER_GRASS", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitBasic", evoLineId = 3, hp = 50, retreatCost = 2, numMoves = 1,
		moves = fields.moves({ { name = "PetalDance" } }) },
	{ id = "MONSTER_017", name = "SplitEvo", type = "MONSTER_GRASS", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitBasic", evoLineId = 3, hp = 30, retreatCost = 1, numMoves = 2,
		moves = fields.moves({ { name = "SolarBeam" }, { name = "Pollen" } }) },
	{ id = "MONSTER_018_1", name = "SecondEvo", type = "MONSTER_GRASS", stage = "STAGE_2",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitEvo", evoLineId = 3, hp = 60, retreatCost = 2, numMoves = 2,
		moves = fields.moves({ { name = "FrenzyPlant" }, { name = "LeafStorm" } }) },
	{ id = "MONSTER_019", name = "SecondEvo", type = "MONSTER_GRASS", stage = "STAGE_2",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitEvo", evoLineId = 3, hp = 110, retreatCost = 3, numMoves = 0,
		moves = fields.moves() },
}
...
card_sets.STD_TEST_CARDS_CURRENT = {
	{ id = "MONSTER_001", name = "SoloOne", type = "MONSTER_FIRE", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 10, hp = 10, retreatCost = 0, numMoves = 1,
		moves = fields.moves({ { name = "CurEmber" } }) },
	{ id = "MONSTER_002", name = "SoloTwo", type = "MONSTER_FIRE", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 11, hp = 20, retreatCost = 1, numMoves = 2,
		moves = fields.moves({ { name = "CurInferno" }, { name = "CurFirePower", category = "POWER" } }) },
	{ id = "MONSTER_003_1", name = "SoloThree", type = "MONSTER_FIRE", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 12, hp = 30, retreatCost = 1, numMoves = 0,
		moves = fields.moves() },
	{ id = "MONSTER_004", name = "SoloFour", type = "MONSTER_WATER", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 13, hp = 100, retreatCost = 2, numMoves = 2,
		moves = fields.moves({ { name = "CurSplash" }, { name = "CurWave" } }) },
	{ id = "MONSTER_005", name = "SoloFive", type = "MONSTER_WATER", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 14, hp = 110, retreatCost = 1, numMoves = 1,
		moves = fields.moves({ { name = "CurWaterPower", category = "POWER" } }) },
	{ id = "MONSTER_006", name = "SoloSix", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "BASIC", evoLineId = 15, hp = 120, retreatCost = 3, numMoves = 2,
	...
	{ id = "MONSTER_010", name = "InvertedBasic", type = "MONSTER_FIRE", stage = "BASIC",
		evoLineMaxStage = "STAGE_1", evoLineId = 1, hp = 80, retreatCost = 3, numMoves = 1,
		moves = fields.moves({ { name = "CurBurn" } }) },
	{ id = "MONSTER_011", name = "InvertedEvo", type = "MONSTER_FIRE", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_1", prevEvoName = "InvertedBasic", evoLineId = 1, hp = 40, retreatCost = 1, numMoves = 2,
		moves = fields.moves({ { name = "CurHeat" }, { name = "CurInferno" } }) },

	{ id = "MONSTER_012", name = "OrderedBasic", type = "MONSTER_WATER", stage = "BASIC",
		evoLineMaxStage = "STAGE_1", evoLineId = 2, hp = 50, retreatCost = 1, numMoves = 0,
		moves = fields.moves() },
	{ id = "MONSTER_013", name = "OrderedEvo", type = "MONSTER_WATER", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_1", prevEvoName = "OrderedBasic", evoLineId = 2, hp = 60, retreatCost = 2, numMoves = 1,
		moves = fields.moves({ { name = "CurSurf" } }) },

	{ id = "MONSTER_014", name = "SplitBasic", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "STAGE_2", evoLineId = 3, hp = 20, retreatCost = 0, numMoves = 2,
		moves = fields.moves({ { name = "CurVine" }, { name = "CurRazor" } }) },
	{ id = "MONSTER_015", name = "SplitBasic", type = "MONSTER_GRASS", stage = "BASIC",
		evoLineMaxStage = "STAGE_2", evoLineId = 3, hp = 80, retreatCost = 3, numMoves = 1,
		moves = fields.moves({ { name = "CurSeedPower", category = "POWER" } }) },
	{ id = "MONSTER_016", name = "SplitEvo", type = "MONSTER_GRASS", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitBasic", evoLineId = 3, hp = 40, retreatCost = 1, numMoves = 2,
		moves = fields.moves({ { name = "CurPetal" }, { name = "CurSolar" } }) },
	{ id = "MONSTER_017", name = "SplitEvo", type = "MONSTER_GRASS", stage = "STAGE_1",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitBasic", evoLineId = 3, hp = 100, retreatCost = 3, numMoves = 0,
		moves = fields.moves() },
	{ id = "MONSTER_018_1", name = "SecondEvo", type = "MONSTER_GRASS", stage = "STAGE_2",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitEvo", evoLineId = 3, hp = 10, retreatCost = 3, numMoves = 1,
		moves = fields.moves({ { name = "CurFrenzy" } }) },
	{ id = "MONSTER_019", name = "SecondEvo", type = "MONSTER_GRASS", stage = "STAGE_2",
		evoLineMaxStage = "STAGE_2", prevEvoName = "SplitEvo", evoLineId = 3, hp = 30, retreatCost = 1, numMoves = 2,
