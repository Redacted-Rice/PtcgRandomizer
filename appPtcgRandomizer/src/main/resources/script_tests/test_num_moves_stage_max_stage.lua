...
return {
	{
		...
		module = "num_moves_stage_max_stage",
		seed = seed,
		args = {
			source = "ROM",
		...
		expect = {
			{ id = "MONSTER_001", numMoves = 1 }, -- BASIC/BASIC
			...
			{ id = "MONSTER_016", numMoves = 1 }, -- STAGE_1/STAGE_2
			{ id = "MONSTER_017", numMoves = 2 }, -- STAGE_1/STAGE_2

			{ id = "MONSTER_018_1", numMoves = 0 }, -- STAGE_2/STAGE_2
	...
	},
	{
		...
		expect = {
			...
			{ id = "MONSTER_003_1", numMoves = 2 }, -- BASIC/BASIC
			{ id = "MONSTER_004", numMoves = 1 }, -- BASIC/BASIC
			{ id = "MONSTER_005", numMoves = 0 }, -- BASIC/BASIC
			{ id = "MONSTER_006", numMoves = 2 }, -- BASIC/BASIC

			{ id = "MONSTER_010", numMoves = 1 }, -- BASIC/STAGE_1
			{ id = "MONSTER_012", numMoves = 0 }, -- BASIC/STAGE_1
			...
			{ id = "MONSTER_017", numMoves = 0 }, -- STAGE_1/STAGE_2

			{ id = "MONSTER_018_1", numMoves = 2 }, -- STAGE_2/STAGE_2
			{ id = "MONSTER_019", numMoves = 1 }, -- STAGE_2/STAGE_2
		},
