	...
	arguments = pool.standardArgs({
		{
			...
			description = "When enabled the attacks are pooled and randomized by Energy type so, for example, a fire type card will only get attacks from Fire type cards ",
			definition = {
				type = "boolean",
			},
			default = false,
